...
$(document).ready(function() {
  ...
  if ($("body").data("title") == "addResourc") {
	...
	if ($("body").data("title") == "myAnnouncement") {
		   r = JSON.parse(localStorage.getItem("dat")).result;
		    console.log(r.id);
		 document.getElementById("submitResourse").onclick = async function() {
      ...
      while (myNode.firstChild) {
	   ...
	   var tag = 	"<tr> <th>type</th> <th>due_date</th> <th>description</th><th>marks</th><th>subject</th><th>time</th><th>title</th><th>attachment</th><th>grade</th><th>section</th><th>suggestion</th><th>subject ids</th></tr>" 
	  document.getElementById("main").insertAdjacentHTML("beforeend", tag);
	  
	 var tag = "<tr>  <td>"+ data.resources[0].type +"</td><td>"+data.resources[0].due_date +"</td> <td>"+data.resources[0].description +"</td>"+
	 "<td>"+ data.resources[0].marks +"</td>"+"<td>"+ data.resources[0].subject +"</td>"+"<td>"+ data.resources[0].time +"</td>"+
	 "<td>"+ data.resources[0].title +"</td>"+"<td>"+ data.resources[0].attachment +"</td>";
	 
	 var grade="<td>",i=0;
	 while (i<data.resources[0].grade.length){
		 grade=grade.concat(data.resources[0].grade[i]+" ");
		 i=i+1;
	 }
	 grade=grade+"</td>";
	 
	  var section="<td>";  i=0;
	 while (i<data.resources[0].section.length){
		 section=section.concat(data.resources[0].section[i]+" ");
		 i=i+1;
	 }
	 section=section+"</td>";
	 
	   var sug="<td>";  i=0;
	 while (i<data.resources[0].suggestion.length){
		 sug=sug.concat(data.resources[0].suggestion[i]+", ");
		 i=i+1;
	 }
	 sug=sug+"</td>";
	  ...
	  var sub_id="<td>";  i=0;
	 while (i<data.resources[0].subject_id.length){
		 sub_id=sub_id.concat(data.resources[0].subject_id[i]+", ");
		 i=i+1;
	 }
	 sub_id=sub_id+"</td></tr>";
	...
	if ($("body").data("title") == "Library") {
      ...
      while (myNode.firstChild) {
	   ...
	   var tag = 	"<tr> <th>author</th> <th>description</th> <th>file</th><th>id</th><th>subject</th><th>time</th><th>title</th><th>video_url</th><th>Class</th><th>is_archive</th><th>tags</th></tr>" 
	  document.getElementById("main").insertAdjacentHTML("beforeend", tag);
